...
public class InitDb {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            ...
            Book book1 = new Book();
            book1.setName("JPA1 BOOK"); book1.setPrice(10000);
            book1.setStockQuantity(100); em.persist(book1);

            Book book2 = new Book(); book2.setName("JPA2 BOOK");
            book2.setPrice(20000); book2.setStockQuantity(100);
            em.persist(book2);
        ...
        public void dbInit2() {
            ...
            em.persist(book1); Book book2 = new Book();
